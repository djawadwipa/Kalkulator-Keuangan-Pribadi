...
data class AccountEntity(
    ...
    val name: String,
    val type: String,
    @ColumnInfo(name = "opening_balance") val openingBalance: Long = 0,
...
@Entity(
    ...
    indices = [Index(value = ["account_id"]), Index(value = ["category_id"]), Index(value = ["occurred_at"]), Index(value = ["type"])],
)
...
data class FinancialProfileEntity(
    ...
    @ColumnInfo(name = "monthly_income_target") val monthlyIncomeTarget: Long = 0,
    @ColumnInfo(name = "savings_target_percent") val savingsTargetPercent: Int = 20,
...
@Entity(
    ...
    indices = [Index(value = ["category_id"]), Index(value = ["month_start", "category_id"], unique = true)],
)
data class BudgetEntity(
    @PrimaryKey(autoGenerate = true) val id: Long = 0,
    @ColumnInfo(name = "month_start") val monthStart: Long,
    @ColumnInfo(name = "category_id") val categoryId: Long,
    @ColumnInfo(name = "limit_amount") val limitAmount: Long,
    @ColumnInfo(name = "updated_at") val updatedAt: Long,
)

@Entity(tableName = "savings_goals", indices = [Index(value = ["type"]), Index(value = ["is_archived"])])
data class SavingsGoalEntity(
    ...
    @ColumnInfo(name = "monthly_contribution_target") val monthlyContributionTarget: Long = 0,
    @ColumnInfo(name = "is_archived") val isArchived: Boolean = false,
...
@Entity(
    ...
    foreignKeys = [ForeignKey(entity = SavingsGoalEntity::class, parentColumns = ["id"], childColumns = ["goal_id"], onDelete = ForeignKey.CASCADE)],
    indices = [Index(value = ["goal_id"]), Index(value = ["contributed_at"])],
)
...
data class MonthlyReviewEntity(
    @PrimaryKey @ColumnInfo(name = "month_start") val monthStart: Long,
    val score: Int,
...
@Entity(tableName = "monthly_report_snapshots", indices = [Index(value = ["month_start"], unique = true)])
data class MonthlyReportSnapshotEntity(
    @PrimaryKey(autoGenerate = true) val id: Long = 0,
    @ColumnInfo(name = "month_start") val monthStart: Long,
    val income: Long,
    val expense: Long,
    @ColumnInfo(name = "net_cash_flow") val netCashFlow: Long,
    @ColumnInfo(name = "savings_rate") val savingsRate: Double,
    @ColumnInfo(name = "budget_adherence") val budgetAdherence: Double,
...
data class SavingsGoalRecord(
    ...
    @ColumnInfo(name = "monthly_contribution_target") val monthlyContributionTarget: Long,
